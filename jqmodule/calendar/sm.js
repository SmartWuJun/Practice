        ...
        p.monthHTML = function(date, offset) {
            ...
            for (i = 1; i <= rows; i++) {
                ...
                for (j = 1; j <= cols; j++) {
                    ...
                    var date = dayYear + '-' + (dayMonth + 1) + '-' + dayNumber;
                    rowHTML += '<div data-year="' + dayYear + '" data-month="' + dayMonth + '" data-day="' + dayNumber + '" class="picker-calendar-day' + (addClass) + '" data-date="' + (dayYear + '-' + dayMonth + '-' + dayNumber) + '"><span>' + dayNumber + '</span><em>' + (p.params.prices[date] ? ('￥' + p.params.prices[date]) : '') + '</em></div>';
                }
