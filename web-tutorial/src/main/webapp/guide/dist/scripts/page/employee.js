...
(function () {
    ...
    var employeeCreateController = function ($scope, tutorialService, dialogService) {
        ...
        /*组织部门组件*/
        $scope.getDepartment = function(backdata) {
            var param={
                isActive:true,
    ...
    var employeeViewController = function ($scope, $modal,$location, tutorialService, dialogService, toolsService) {
    ...
    var UpPhotoController = ["$scope", "$modalInstance" ,"items", "tutorialService","myService", "dialogService",
        function ($scope, $modalInstance, items, tutorialService, myService,dialogService) {
            ...
            $scope.doSave=function () {
                if(!$scope.vm.fileExt){
                    dialogService.tip([{"message": "请先设置图片！" }]);
                    return ;
                }
    ...
    angular.module("xn.page", ["xn.directive.form"])
        ...
        .controller("EmployeeViewController", ["$scope", "$modal", "$location", "tutorialService", "dialogService", "toolsService", employeeViewController]);
