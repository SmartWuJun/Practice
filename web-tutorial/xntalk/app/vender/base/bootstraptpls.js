...
angular.module('ui.bootstrap.pagination', [])
    ...
    .controller('PaginationController', ['$scope', '$attrs', '$parse', function ($scope, $attrs, $parse) {
        ...
        $scope.isNumber = function(e) {
            ...
            if(target.val()>$scope.totalPages) {
                $scope.page = $scope.totalPages;
                target.val($scope.totalPages);
            }
        };

        $scope.noChoose = function(page) {
...
angular.module("template/pagination/pagination.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("template/pagination/pagination.html",
            ...
            "  <div class=\"selectPage\"><span>去到</span><input ng-keyup=\"isNumber($event)\" ng-model=\"page\" type=\"text\" /><a href ng-class=\"{disabled: noChoose()}\" ng-click=\"choosePage(page)\">确定</a></div>\n" +
            "</ul>\n" );
