...
var page = {
	init:function () {
		var options= {
			appKey: '0617ca8376f9901f28ff46b69bf9cf44',
	        account: localStorage.getItem("uid"),
	        id: util.getIdTag(),
	        token: localStorage.getItem("sdktoken"),
	        chatroomNick:localStorage.getItem("nickName"),
	        chatroomAvatar:localStorage.getItem("avatar")
    	}

		if(require('electron').remote.getGlobal('isDev') != true)
		{
			options.appKey = '0617CA8376F9901F28FF46B69BF9CF47';
		}
		else
		{
			options.appKey = '0617CA8376F9901F28FF46B69BF9CF44';
		}

    	this.account = localStorage.getItem("uid");
    	this.offsetTime = 0;
    	this.initNode();
    	this.initEmoji();
		this.initEvt();
