var areaData=[
    ...
    {id:500223,name:"潼南县",pid:"500100",type:"district",pinyin:"tong nan xian",py:"tnx",prefix:"t"},
    {id:500224,name:"铜梁县",pid:"500100",type:"district",pinyin:"tong liang xian",py:"tlx",prefix:"t"},
    {id:500226,name:"荣昌县",pid:"500100",type:"district",pinyin:"rong chang xian",py:"rcx",prefix:"r"},
    {id:500227,name:"璧山县",pid:"500100",type:"district",pinyin:"bi shan xian",py:"bsx",prefix:"b"},
    {id:500228,name:"梁平县",pid:"500100",type:"district",pinyin:"liang ping xian",py:"lpx",prefix:"l"},
    {id:500229,name:"城口县",pid:"500100",type:"district",pinyin:"cheng kou xian",py:"ckx",prefix:"c"},
    {id:500230,name:"丰都县",pid:"500100",type:"district",pinyin:"feng dou xian",py:"fdx",prefix:"f"},
    {id:500231,name:"垫江县",pid:"500100",type:"district",pinyin:"dian jiang xian",py:"djx",prefix:"d"},
    {id:500232,name:"武隆县",pid:"500100",type:"district",pinyin:"wu long xian",py:"wlx",prefix:"w"},
    {id:500233,name:"忠县",pid:"500100",type:"district",pinyin:"zhong xian",py:"zx",prefix:"z"},
    {id:500234,name:"开县",pid:"500100",type:"district",pinyin:"kai xian",py:"kx",prefix:"k"},
    {id:500235,name:"云阳县",pid:"500100",type:"district",pinyin:"yun yang xian",py:"yyx",prefix:"y"},
    {id:500236,name:"奉节县",pid:"500100",type:"district",pinyin:"feng jie xian",py:"fjx",prefix:"f"},
    {id:500237,name:"巫山县",pid:"500100",type:"district",pinyin:"wu shan xian",py:"wsx",prefix:"w"},
    {id:500238,name:"巫溪县",pid:"500100",type:"district",pinyin:"wu xi xian",py:"wxx",prefix:"w"},
    {id:500240,name:"石柱土家族自治县",pid:"500100",type:"district",pinyin:"shi zhu tu jia zu zi zhi xian",py:"sztjzzzx",prefix:"s"},
    {id:500241,name:"秀山土家族苗族自治县",pid:"500100",type:"district",pinyin:"xiu shan tu jia zu miao zu zi zhi xian",py:"xstjzmzzzx",prefix:"x"},
    {id:500242,name:"酉阳土家族苗族自治县",pid:"500100",type:"district",pinyin:"you yang tu jia zu miao zu zi zhi xian",py:"yytjzmzzzx",prefix:"y"},
    {id:500243,name:"彭水苗族土家族自治县",pid:"500100",type:"district",pinyin:"peng shui miao zu tu jia zu zi zhi xian",py:"psmztjzzzx",prefix:"p"},
    ...
    {id:441901,name:"直辖市",pid:"441900",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"},        //东莞
    {id:442001,name:"直辖市",pid:"442000",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"},        //中山市
    {id:460201,name:"直辖市",pid:"460200",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"},        //三亚市
    {id:620201,name:"直辖市",pid:"620200",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"},      //嘉峪关
    {id:820101,name:"直辖市",pid:"820100",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"},      //澳门半岛
    {id:820201,name:"直辖市",pid:"820200",type:"district",pinyin:"zhi xia qu",py:"zxq",prefix:"z"}      //澳门离岛
];
...
angular.forEach(areaData, function(city){
    if(city.type=="province"){
        switch (city.prefix){
            ...
            case "f":
            case "g":
                ProvinceList.AGList.push(city);
                break;
            case "h":
            case "i":
            case "j":
            case "k":
                ProvinceList.HKList.push(city);
                break;
            case "l":
            case "m":
            case "n":
...
angular.module("xn/template/location/location.html",[])
    ...
    $templateCache.put("xn/template/location/location.html",
            ...
            "   <div class=\"xn-input-line clearfix\" ng-show=\"ifCountry\">" +
            "       <div class='xn-location-select'> "+
            "           <select class=\"form-control\" ng-required='nation'  name=\"countryId\" ng-model=\"location.countryId\">" +
            "               <option value=\"\">--请选择国家--</option>" +
            "               <option ng-selected=\"area.id==location.countryId\"" +
            "                       ng-repeat=\"area in countryList=(areaList | filter:countryListFilter)\"" +
            "                       value=\"{{area.id}}\">" +
            "                   {{area.name}}" +
            "               </option>" +
            "           </select>" +
            "       </div> "+
            "       <div class='xn-location-select xn-text-right' ng-show=\"isAddress\"> 邮编：</div> "+
            "       <div class='xn-location-select' ng-show=\"isAddress\"> "+
            "           <input class=\"form-control  \" name=\"postCode\" ng-model=\"location.postCode\" placeholder=\"邮编\" ng-pattern=\"\/^[1-9]\\d{5}$/\">" +
            "       </div> "+
            "    </div>" +
            ...
            "        </div>" +
            "    </div>"+
            "    <div class=\"xn-input-line clearfix\" ng-show=\"isAddress\">" +
...
//物流城市指令
angular.module("xn/template/location/xnProvinceCityDistrict.html",[])
    .run(["$templateCache", function($templateCache) {
        "use strict";
        $templateCache.put("xn/template/location/xnProvinceCityDistrict.html",
                "<div class=\"xn-location-city\" id=\"{{ProvinceId}}\">\n" +
                "   <div class='xn-location-province-city'>\n" +
                "       <div class='city-edit' ng-click=\"doOpen()\">{{openName}}</div>\n" +
                "       <ul class='city-list clearfix'>\n" +
                "            <li class='list-span'  ng-repeat=\"district in selectDistrict.districtList\" >" +
                "                <span ng-if=\"district.city.province.isSelected && district.city.isProvinceShow && district.isCityShow\" >{{district.city.province.name}} ;</span>" +
                "                <span ng-if=\"district.city.isSelected && district.isCityShow && !district.city.province.isSelected \">{{district.city.name}} ;</span>" +
                "                <span ng-if=\"!district.city.province.isSelected && !district.city.isSelected\" >{{district.city.name}}-{{district.name}} ;</span>" +
                "            </li>"+
                "       </ul>\n"+
                "    </div>\n"+
                "   <div class=\"open-city\" ng-if=\"openCity\">"+
                "       <button type=\"button\" class=\"close\" ng-click=\"closeCity()\">×</button>\n"+
                "       <h4>请选择</h4>\n"+
                "       <ul class='province-city-contect clearfix'>" +
                "           <li class='province-line clearfix' ng-repeat=\"province in provinceList\" >" +
                ...
                "                   <i class=\"xn-checkbox\"></i> " +
                "                   <i class=\"icon icon-right_3\" ng-show=\"province.isSelected\"></i>" +
                "                     <div class='name' title=\"{{province.name}}\">{{province.name}}</div>" +
                "               </label>" +
                "               <i class=\"icon icon-downward-1\"   ng-click=\"openChild(province)\" ></i>" +
                "              </div>" +
                "              <ul class='child-list city-child-list clearfix' ng-if=\"province.openChild\">" +
                "                  <li class='list clearfix'  ng-repeat=\"city in province.childList\">" +
                "                       <div class='province-line-box'   ng-class=\"{'city-line-box-hover':city.openChild}\">  " +
                "                           <label class=\" xn-label-checkbox\" ng-click=\"doCity(city)\">" +
                "                                <i class=\"xn-checkbox\"></i> " +
                "                                <i class=\"icon icon-right_3\" ng-show=\"city.isSelected\"></i>" +
                "                                <div class='name' title=\"{{city.name}}\">{{city.name}}</div>" +
                "                           </label>" +
                "                           <i class=\"icon icon-downward-1\"   ng-click=\"openCityChild(city)\" ></i>" +
                "                       </div> " +
                "                       <ul class='child-list clearfix' ng-if=\"city.openChild\">" +
                "                           <li class='list clearfix'  ng-repeat=\"district in city.childList\">" +
                "                                <label class=\" xn-label-checkbox\" ng-click=\"doDistrict(district)\">" +
                "                                     <i class=\"xn-checkbox\"></i> " +
                "                                     <i class=\"icon icon-right_3\" ng-show=\"district.isSelected\"></i>" +
...
angular.module("xn/template/location/xnProvinceCityDistrictView.html",[])
    .run(["$templateCache", function($templateCache) {
        "use strict";
        $templateCache.put("xn/template/location/xnProvinceCityDistrictView.html",
                "<div class=\"xn-location-city\" \">\n" +
                "   <div class='xn-location-province-city'>\n" +
                "       <ul class='city-list clearfix'>\n" +
                "            <li class='list-span'  ng-repeat=\"district in selectDistrict.districtList\" >" +
...
//选择省市区的指令
angular.module("xn/template/location/xnLocationDistrict.html",[])
    .run(["$templateCache", function($templateCache) {
        "use strict";

        $templateCache.put("xn/template/location/xnLocationDistrict.html",
                "<div class=\"xn-location-district\" >\n"+
                "    <div  class=\"form-control\"    ng-click=\"openBox()\"   >" +
                "       <i class=\"location-apostrophe icon icon-apostrophe\"></i>" +
                "      <div class='location-content'>"+
                "       <span > {{location.provinceName}} </span>" +
                "       <span ng-if=\"location.cityName\">- {{location.cityName}} </span>" +
                "       <span  ng-if=\"location.districtName\">- {{location.districtName}} </span>" +
                "       </div> " +

                "    </div>\n"+
                "        <div class=\"location-box\" ng-show=\"vm.locationBox\">"+
                /*    "            <button type=\"button\" class=\"close\" ng-click=\"openLocationBox()\">×</button>\n"+*/
                "            <ul class=\"nav-location clearfix\">\n" +
                "               <li class='isolate-scope' ng-class=\"{'active':vm.navActive==1} \"  ng-click=\"tabNav(1)\"><span>*</span>省</li>"+
                "               <li class='isolate-scope' ng-class=\"{'active':vm.navActive==2} \"  ng-click=\"tabNav(2)\"><span>*</span>市</li>"+
                "               <li class='isolate-scope' ng-class=\"{'active':vm.navActive==3} \"  ng-click=\"tabNav(3)\"><span>*</span>区县</li>"+
                "               <li class='isolate-clear'  ng-click=\"closeLocation()\">关闭</li>"+
                "               <li class='isolate-clear'  ng-click=\"clearLocation()\">清空</li>"+
                "            </ul>" +
                "           <div class='clearfix'></div>" +
                "           <div class='tab-content'>" +
                "             <div class='info' ng-if=\"vm.info!=''\"><span class='span'>{{vm.info}}</span></div>" +
                "               <div ng-show=\"vm.navActive==1\" class='province' >" +
                "                  <dl class=\"province-dl clearfix\">\n"+
                "                      <dt class='province-dt'>A-G</dt>\n"+
                "                       <dd class='province-dd'>\n"+
                "                            <span class='span-scope' title=\"{{province.name}}\" ng-repeat=\"province in provinceList.AGList\"  ng-click=\"selectProvince(province)\">{{province.name}}</span>\n"+
                "                        </dd>\n"+
                "                   </dl>\n"+
                "                  <dl class=\"province-dl clearfix\">\n"+
                "                      <dt class='province-dt'>H-K</dt>\n"+
                "                       <dd class='province-dd'>\n"+
                "                            <span class='span-scope' title=\"{{province.name}}\" ng-repeat=\"province in provinceList.HKList\"  ng-click=\"selectProvince(province)\">{{province.name}}</span>\n"+
                "                        </dd>\n"+
                "                   </dl>\n"+
                "                  <dl class=\"province-dl clearfix\">\n"+
                "                      <dt class='province-dt'>L-S</dt>\n"+
                "                       <dd class='province-dd'>\n"+
                "                            <span class='span-scope' title=\"{{province.name}}\" ng-repeat=\"province in provinceList.LSList\"  ng-click=\"selectProvince(province)\">{{province.name}}</span>\n"+
                "                        </dd>\n"+
                "                   </dl>\n"+
                "                  <dl class=\"province-dl clearfix\">\n"+
                "                      <dt class='province-dt'>T-Z</dt>\n"+
                "                       <dd class='province-dd'>\n"+
                "                            <span class='span-scope' title=\"{{province.name}}\" ng-repeat=\"province in provinceList.TZList\"  ng-click=\"selectProvince(province)\">{{province.name}}</span>\n"+
                "                        </dd>\n"+
                "                   </dl>\n"+
                "               </div>" +
                "               <div ng-show=\"vm.navActive==2\" class='city'>" +
                "                 <span class='span-scope' title=\"{{city.name}}\" ng-repeat=\"city in cityList\"  ng-click=\"selectCity(city)\">{{city.name}}</span>\n"+
                "                 <span ng-if=\"cityList.length==0\" >请先选择省!</span>\n"+
                "               </div>" +
                "               <div ng-show=\"vm.navActive==3\" class='district'>" +
                "                 <span class='span-scope' title=\"{{district.name}}\" ng-repeat=\"district in districtList\"  ng-click=\"selectDistrict(district)\">{{district.name}}</span>\n"+
                "                 <span ng-if=\"districtList.length==0\">请先选择市!</span>\n"+
                "             </div>" +
                "           </div>\n"+
                "       </div>\n"+
                "</div>"
...
//多选省份
angular.module("xn/template/location/xnProvince.html",[])
    .run(["$templateCache", function($templateCache) {
        "use strict";

        $templateCache.put("xn/template/location/xnProvince.html",
            "<div class=\"xn-location-city\" id=\"{{ProvinceId}}\">\n" +
            "<div class='xn-location-province-city'>\n" +
            "<div class='city-edit' ng-click=\"doOpen()\">{{openName}}</div>\n" +
            "<ul class='city-list clearfix'>\n" +
            "<li class='list-span'  ng-repeat=\"province in selectProvinceList.provinceList\"  >{{province.name}}</li>"+
            "</ul>\n"+
            "</div>\n"+
            "   <div class=\"open-city\" ng-show=\"openCity\">"+
            ...
            "       <h4>请选择</h4>\n"+
            "       <ul class='province-city-contect clearfix'>" +
            "           <li class='province-line-break  clearfix ' ng-repeat=\"province in provinceList\" >" +
            "              <label class=\"xn-label-checkbox\" ng-click=\"selectProvince(province)\">" +
            "                   <i class=\"xn-checkbox\"></i> " +
            "                   <i class=\"icon icon-right_3\" ng-show=\"province.isSelected\"></i>" +
            "                     <div class='name'>{{province.name}}</div>" +
            ...
            "</li>" +
            "       </ul>\n"+
            "<div class='p_10 clearfix'>"+
            "<label class='f-left cursor-pointer check-all-checkbox' ng-click='checkAll()'>"+
            "     <i class=\"xn-checkbox\"></i> " +
            "     <i class=\"icon icon-right_3\" ng-show=\"isSelected\" ng-init=\"isSelected=false\"></i>全选"+
            "</label> "+
            "<span class='f-right cursor-pointer' ng-click='clean()'>清空</span>"+
            "</div>"+
            "  </div>\n"+
            "</div>"
...
angular.module("xn/template/location/xnMultipleProvinceSelect.html",[])
    .run(["$templateCache", function($templateCache) {
        "use strict";
         $templateCache.put("xn/template/location/xnMultipleProvinceSelect.html",
        ...
        +"              </label> "
        +"       </div>"
        +"            <div class='btn btn-link f-right' ng-click='doConfirm()'><span>关闭</span></div>"
        +"            <div class='btn btn-link f-right' ng-click='doConsole()'><span>取消选择</span></div>"
        +"        </div>"
        +"        <div class='level-content'>"
        +"            <div class='level-content-box'>"
        +"                <div class=' xn-tree-item' ng-repeat='data in provinceList' ng-click='selectProvince(data)'>"
...
angular.module("xn/template/location.html",[
    ...
    "xn/template/location/xnProvinceCityDistrict.html",
    "xn/template/location/xnProvinceCityDistrictView.html",
    "xn/template/location/xnLocationDistrict.html",
    "xn/template/location/xnProvince.html",
    "xn/template/location/xnMultipleProvinceSelect.html"
    ]);

//多选省份
var xnMultipleProvince = function ($http, $filter, AreaData) {
    return {
        restrict: "A",
        templateUrl: "xn/template/location/xnProvince.html",
        scope: {
            selectProvinceId: '=ngModel',
        ...
        link: function (scope, elem, attrs, ngModel) {
            ...
            //所有省
            scope.provinceList=[];
            scope.allList = angular.copy(AreaData);
            angular.forEach(scope.allList,function(area){
            ...
            scope.selectProvinceId=scope.selectProvinceList.idList;
            ...
            scope.selectProvince=function(data){
                if(!data.isSelected){
                    ...
                    var pro=angular.copy(data);
                    scope.selectProvinceList.idList.push(pro.id);
                    scope.selectProvinceList.provinceList.push(pro);
                    if(scope.selectProvinceList.provinceList.length==scope.provinceList.length){
                        scope.isSelected=true;
                    }

                }else{
                    scope.isSelected=false;
                    angular.forEach(scope.selectProvinceList.idList,function(id,index){
                        if(id ==data.id){
                            scope.selectProvinceList.idList.splice(index,1);
                            scope.selectProvinceList.provinceList.splice(index,1);
                            data.isSelected=!data.isSelected;
                        }
                    })
                }
            ...
            scope.checkAll=function(){
                if(scope.selectProvinceList.provinceList.length == scope.provinceList.length){
                    ...
                    scope.selectProvinceList.idList=[];
                    scope.selectProvinceList.provinceList=[];
                    scope.selectProvinceId=scope.selectProvinceList.idList;
                        ...
                        angular.forEach(scope.provinceList,function(data){
                            if(!data.isSelected){
                                ...
                                scope.selectProvinceList.idList.push(data.id);
                                scope.selectProvinceList.provinceList.push(data);
                            }
            ...
            var first=true;
            scope.$watch("provinceIdList",function(newVal,oldVal){
                if(!(newVal=="" ||newVal==null || newVal==undefined)){
                    if(newVal.length && first){
                        angular.forEach(scope.provinceList,function(province){
                            angular.forEach(scope.provinceIdList,function(provinceId){
                                if(province.id==provinceId){
                                    scope.selectProvinceList.provinceList.push(province);
                                    scope.selectProvinceList.idList.push(province.id);
...
//多选省份下拉形式
var xnMultipleProvinceSelect = function ($http, $filter, AreaData) {
    return {
        restrict:"AE",
        templateUrl: "xn/template/location/xnMultipleProvinceSelect.html",
        scope:{
            selectData: "=",
        ...
        link: function($scope, element, attrs, ngModel, fn) {
            ...
            //用于传值
            $scope.selectedData=$scope.selectProvinceList.provinceList;
            ...
            $scope.selectProvince=function(data){
                ...
                angular.forEach($scope.selectProvinceList.provinceList, function (data) {
                    if(data.isSelected) {
                        $scope.selectedDataName.push(data.name);
                    }
                });
            ...
            $scope.$watch("selectData",function(newVal,oldVal){
                if(!(newVal=="" ||newVal==null || newVal==undefined)){
                    if(newVal.length && first){
                        angular.forEach($scope.provinceList,function(province){
                            angular.forEach($scope.selectData,function(provinceId){
                                if(province.id==provinceId){
                                    province.isSelected=true;
                                    $scope.selectProvinceList.provinceList.push(province);
                                    $scope.selectProvinceList.idList.push(province.id);
                                    $scope.selectedDataName.push(province.name);
                                }
                            })
                        });
                        $scope.showName = $scope.selectedDataName;
                        first = false;
                    }
                }
...
var xnLocation = function ($http, $filter, AreaData) {
    return {
        ...
        link: function (scope, elem, attrs, ngModel) {
            ...
            scope.address = false;
            if(!scope.ifCountry){
                scope.ifCountry=false;
            }else{
                scope.ifCountry=true;
            }
            ...
            var location = scope.location = {default: {countryId: "", provinceId: "", cityId: "", districtId: ""},name: {countryName: "", provinceName: "", cityName: "",districtName:"", address: "",postCode:""},
                countryId:"86", provinceId: "", cityId: "", districtId: "",postCode:""};
...
//多选物流地址指令到区
var xnProvinceCityDistrict = function ($http, $filter, AreaData) {
    return {
        restrict: "A",
        templateUrl: "xn/template/location/xnProvinceCityDistrict.html",
        scope: {
            selectDistrictId: '=ngModel',
        ...
        link: function (scope, elem, attrs, ngModel) {
            ...
            scope.selectDistrictId=scope.selectDistrict.idList;
            angular.forEach(scope.areaList,function(area){
                if(area.type=="province"){
                    area.isSelected=false;          //是否被选中
                    area.openChild=false;           //子是否打开
                    area.selectNumber=0;             //子已经选择多少个
                    area.childList=[];               //子列表
                    scope.provinceList.push(area);   //省列表
                }else if(area.type=="city"){
                    angular.forEach(scope.provinceList,function(province){
                        if(province.id==area.pid){
                            area.isSelected=false;
                            ...
                            area.isProvinceShow=false;
                            area.province=province;
                            //push到 scope.provinceList里的childlist里面
                            province.childList.push(area);
                            scope.cityList.push(area);
                        }
                    })
                    ...
                    angular.forEach(scope.cityList,function(city){
                        if(city.id==area.pid){
                            area.isSelected=false;
                            area.isCityShow=false;
                            area.city=city;
                            //push到 scope.provinceList里的childlist里面
                            city.childList.push(area);
                            scope.districtList.push(area);
                        }
                    })
                }
            ...
            var first=true;
            scope.$watch("districtIdList",function(newVal,oldVal){

                if(!(newVal=="" ||newVal==null || newVal==undefined)){
                    if(newVal.length && first){
                        angular.forEach(scope.districtList,function(district){
                            angular.forEach(scope.districtIdList,function(districtId){
                                if(district.id==districtId){
                                    scope.selectDistrict.districtList.push(district);
                                    scope.selectDistrict.idList.push(district.id);
                                    district.isSelected=true;
                                    district.city.selectNumber++;

                                    //设置市
                                    if(district.city.selectNumber==district.city.childList.length){
                                        district.city.isSelected=true;
                                        district.city.childList[0].isCityShow=true;
                                        district.city.province.selectNumber++;

                                        //设置省
                                        if( district.city.province.selectNumber==district.city.province.childList.length){
                                            district.city.province.isSelected=true;
                                            district.city.province.childList[0].isProvinceShow=true;
                                        }
                                    }
                                }
            ...
            scope.closeCity=function(){
                angular.forEach(scope.provinceList,function(data){
                    data.openChild=false;
                    angular.forEach(data.childList,function(dataChild){
                        dataChild.openChild=false;
                    });
                });
                scope.openCity=false;
            };
            ...
            scope.openCityChild=function(city){
                if(!city.openChild){
                    angular.forEach(city.province.childList,function(data){
                        data.openChild=false;
                    });
                    city.openChild=true;
                }else{
                    city.openChild=!city.openChild;
                }
            ...
            scope.selectProvince=function(data){
                if(data.isSelected){
                    //取消选中循环减少-问题，。
                    angular.forEach(data.childList,function(city){          //市
                        city.isSelected=false;
                        for(var index=0;index<city.childList.length;index++){
                            for(var selectIndex=scope.selectDistrict.districtList.length-1;selectIndex>=0;selectIndex--){
                                if(scope.selectDistrict.districtList[selectIndex].id==city.childList[index].id){
                                    scope.selectDistrict.districtList.splice(selectIndex,1);
                                    scope.selectDistrict.idList.splice(selectIndex,1);
                                    city.childList[index].isSelected=false;
                                }
                            }
                        }
                        city.childList[0].isCityShow=false;
                        city.selectNumber=0;
                    });
                    data.isSelected=!data.isSelected;
                    //省份下第一条为false
                    ...
                    //选中
                    angular.forEach(data.childList,function(city,index){
                        if(!city.isSelected){
                            city.isSelected=!city.isSelected;  //改变当前状态

                            //修改县级里的数据
                            angular.forEach(city.childList,function(district){
                                if(!district.isSelected){
                                    scope.selectDistrict.districtList.push(district);
                                    scope.selectDistrict.idList.push(district.id);
                                    district.isSelected=!district.isSelected;
                                    city.selectNumber++;
                                }
                            });
                            data.selectNumber++;
                        }
                        city.childList[0].isCityShow=true;
                    });
                ...
                angular.forEach(scope.provinceList,function(province){
                    if(!(data.id==province.id)){
                        province.openChild=false;
                        angular.forEach(province.childList,function(dataChild){
                            dataChild.openChild=false;
                        });
                    }
                });
            ...
            scope.doCity=function(data){
                if(data.isSelected){
                    //取消选中循环减少有问题，。
                    angular.forEach(data.childList,function(district){
                        for(var selectIndex=scope.selectDistrict.districtList.length-1;selectIndex>=0;selectIndex--){
                            if(scope.selectDistrict.districtList[selectIndex].id==district.id){
                                scope.selectDistrict.districtList.splice(selectIndex,1);
                                scope.selectDistrict.idList.splice(selectIndex,1);
                                district.isSelected=!data.isSelected;
                                district.city.selectNumber--;
                            }
                        }
                    });
                    //省市设置
                    data.isSelected=!data.isSelected;
                    data.childList[0].isCityShow=false;
                    //省设置
                    data.province.selectNumber--;
                    data.province.isSelected=false;
                    data.province.childList[0].isProvinceShow=false;
                    ...
                    data.isSelected=!data.isSelected;
                    data.childList[0].isCityShow=true;
                ...
                angular.forEach(data.province.childList,function(city){
                    if(!(city.id==data.id)){
                        city.openChild=false;
                    }
            ...
            //点击县
            scope.doDistrict=function(district){
                if(district.isSelected){
                    //取消选中循环减少 -问题，。
                    for(var selectIndex=scope.selectDistrict.districtList.length-1;selectIndex>=0;selectIndex--){
                        if(scope.selectDistrict.districtList[selectIndex].id==district.id){
                            ...
                            //先判断市是否全选，全选就应该把市状态改变，并且省减少
                            if(district.city.selectNumber==district.city.childList.length){
                                district.city.province.selectNumber--;
                                district.city.province.isSelected=false;
                                district.city.province.childList[0].isProvinceShow=false;
                            }

                            district.city.selectNumber--;
                            district.city.isSelected=false;
                            //省份下第一条为true
                            district.city.childList[0].isCityShow=false;
                            break;
                        }
                    }
...
//多选物流地址指令到区
var xnProvinceCityDistrictView = function ($http, $filter, AreaData) {
    return {
        restrict: "A",
        templateUrl: "xn/template/location/xnProvinceCityDistrictView.html",
        scope: {
            districtIdList:"=districtIdList"
        },
        replace: true,
...
//单选 省市区
var xnLocationDistrict = function ($http, $filter,$timeout, AreaData,ProvinceList) {
    return {
        restrict: "A",
        templateUrl: "xn/template/location/xnLocationDistrict.html",
        scope: {
            location: '=ngModel'
        },
        replace: true,
        ...
        link: function (scope, elem, attrs, ngModel) {
            ...
            scope.openLocationBox=function(){
                scope.vm.locationBox=!scope.vm.locationBox;
                scope.vm.navActive=1;
            };

            //打开关闭
            scope.openBox=function(){
                scope.vm.locationBox=true;
                scope.vm.navActive=1;
            };
            ...
            scope.clearLocation=function(){
                ...
                scope.cityList=[];
                scope.districtList=[];
                scope.openLocationBox();
            };

            //清空
            scope.closeLocation=function(){
                if(scope.location.provinceId !="" && scope.location.districtId==""){
                    scope.vm.info="请先选择完整的省市区!再关闭！";
                    timeout();
                }else{
                    scope.vm.locationBox=false;
                    scope.vm.navActive=1;
                }
            };
            ...
            scope.selectProvince=function(province){
                scope.location.provinceId=province.id;
                scope.location.provinceName=province.name;
                scope.getCityList();
                scope.vm.navActive=2;
                //清空区
                scope.location.cityId="";
                scope.location.cityName="";
                //清空区
                scope.districtList=[];
                scope.location.districtId="";
                scope.location.districtName="";
            };


            //选择市
            scope.selectCity=function(city){
                scope.location.cityId=city.id;
                scope.location.cityName=city.name;
                scope.getDistrictList();
                if(scope.districtList.length>0){
                    scope.vm.navActive=3;
                }else{
                    scope.vm.navActive=1;
                    scope.openLocationBox();
                }
            ...
            scope.selectDistrict=function(district){
                scope.location.districtId=district.id;
                scope.location.districtName=district.name;
                scope.vm.navActive=1;
                scope.openLocationBox();
            };
            ...
            scope.getCityList=function(){
                scope.cityList=[];
                angular.forEach(scope.areaList,function(area){
                    if(area.type=="city" && (area.pid==scope.location.provinceId)){
                        scope.cityList.push(area)
                    }
                });
            };
            ...
            scope.getDistrictList=function(){
                scope.districtList=[];
                angular.forEach(scope.areaList,function(area){
                    if(area.type=="district" && (area.pid==scope.location.cityId)){
                        scope.districtList.push(area)
                    }
                });
            };
            ...
            scope.$watch("location.provinceId",function(newVal) {
                //如果没事省名称：过滤省名称
                if (newVal && scope.location.cityId && scope.location.districtId) {
                    if (!(scope.location.provinceName && scope.location.cityName && scope.location.districtName)) {
                        angular.forEach(scope.areaList, function (area) {
                            if (newVal==area.id) {
                                scope.location.provinceName = area.name;
                            }
                            if (scope.location.cityId==area.id){
                                scope.location.cityName = area.name;
                            }
                            if (scope.location.districtId==area.id){
                                scope.location.districtName = area.name;
                            }
                    ...
                    scope.getCityList();
                    scope.getDistrictList();
                }else if(newVal && scope.location.cityId){
                    if (!(scope.location.provinceName && scope.location.cityName)) {
                        angular.forEach(scope.areaList, function (area) {
                            if (newVal==area.id) {
                                scope.location.provinceName = area.name;
                            }
...
angular.module("xn.directive.location",["xn/template/location.html"])
    ...
    .constant('ProvinceList', ProvinceList)
    ...
    .directive('xnProvinceCityView', ["$http", "$filter","AreaData", xnProvinceCityView])
    .directive('xnProvinceCityDistrict', ["$http", "$filter","AreaData", xnProvinceCityDistrict])
    .directive('xnProvinceCityDistrictView', ["$http", "$filter","AreaData", xnProvinceCityDistrictView])
    .directive('xnLocationDistrict', ["$http", "$filter","$timeout","AreaData","ProvinceList", xnLocationDistrict])
    .directive('xnMultipleProvince', ["$http", "$filter","AreaData", xnMultipleProvince])
    .directive('xnMultipleProvinceSelect', ["$http", "$filter","AreaData", xnMultipleProvinceSelect]);
