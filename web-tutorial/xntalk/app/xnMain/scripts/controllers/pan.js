...
(function () {
    ...
    var panController = function($scope, $http,$q, $modal,$filter,talkService,dialogService) {
        $scope.isShow = true;
        ...
        $scope.moveFolder = function(targetId, object) {
            ...
            talkService.xnTalkFolderMove(vm).then(function(data){
                if (data.errors == null || data.errors.length > 0){
                    dialogService.tip(data.errors);
                }else{
                    $scope.flag=false;
        ...
        $scope.deleteFolder = function(id) {
            ...
            var dialogOptions={
                ...
                callback:function(){
                    ...
                    talkService.xnTalkFolderDelete(vm).then(function(data){
                        if (data.errors == null || data.errors.length > 0){
                            dialogService.tip(data.errors)
                        }else{
                            $scope.flag=false;
            ...
            var dialogOptions={
                ...
                callback:
                    function(){
                        ...
                        talkService.xnTalkFolderFileByIdsDelete(vm).then(function(data){
                            if (data.errors == null || data.errors.length > 0){
                                dialogService.tip(data.errors)
                            }else{
                                $scope.flag=false;
    ...
    angular.module('myApp')
        ...
        .controller("PanController", ["$scope", "$http","$q", "$modal","$filter","talkService","dialogService", panController])
