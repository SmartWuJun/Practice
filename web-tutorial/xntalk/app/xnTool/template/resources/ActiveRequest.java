/*
 * @(#){{ table.nameNoPrefix | pascalcase }}ActiveRequest.java
 *
...
/**
 * 激活{{ table.meaning }}的请求.
 * @author {{ setting.developerName}}
 */
public class {{ table.nameNoPrefix | pascalcase }}ActiveRequest extends BaseUpdateRequest {
