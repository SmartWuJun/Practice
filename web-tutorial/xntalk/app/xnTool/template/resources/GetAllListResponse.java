/*
 * @(#){{ table.nameNoPrefix | pascalcase }}GetAllListResponse.java
 *
...
import com.{{ setting.companyCode | lower}}.framework.base.BaseGetAllListResponse;

/**
 *
 * @author {{ setting.developerName}}
 */
public class {{ table.nameNoPrefix | pascalcase }}GetAllListResponse extends BaseGetAllListResponse<{{ table.nameNoPrefix | pascalcase }}> {
