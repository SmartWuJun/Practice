/*
 * @(#){{ table.nameNoPrefix | pascalcase }}Import.java
 *
 ...
 */
public class {{ table.nameNoPrefix | pascalcase }}Import extends  BaseDomain {

{% for column in table.columnsNoId %}
    /**
     * {{ column.meaning  }} {{ column.description  }}
     */
    private {{ column.java }} {{ column.name | camelcase }};
{% endfor %}{% for column in table.columnsNoId %}
