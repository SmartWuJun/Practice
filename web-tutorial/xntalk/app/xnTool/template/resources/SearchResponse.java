/*
 * @(#){{ table.nameNoPrefix | pascalcase }}SearchResponse.java
 *
...
import com.{{ setting.companyCode | lower}}.framework.base.BaseSearchResponse;

/**
 * 模糊查询{{ table.meaning }}的响应.
 * @author {{ setting.developerName}}
 */
public class {{ table.nameNoPrefix | pascalcase }}SearchResponse extends BaseSearchResponse<{{ table.nameNoPrefix | pascalcase }}> {
